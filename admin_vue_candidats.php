        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <div class="fiche">
            ...
            <img src="<?php echo $row['img_path'] ?>" width="250px" height="300px"
              style="top: 20%; left: 85%; position: relative;">
              ...
              <div class='right-container'>
                ...
                <div class='set'>
                  ...
                  <div class='set'>
                    ...
                    <br>
                    <?php
                    //venant de la page ajout candidat (appuit sur ajouter un candidat)
                  
                    // echo "<br><a href='admin_vue_candidats.php/?id_c=" . $row['id_c'] . "'>Voulez-vous inscrire cet indvidu?<a/>";
                    ...
                    if (isset($_GET['id_c'])) { ?>
                      <form class="form" action="admin_operations_candidats.php" method="post">
                        ...
                        tarif de code:<input type="text" name="tarif_code" class="input" placeholder="tarif de code"
                          type="text" default="20 DT">
                        tarif de conduite: <input type="text" name="tarif_conduite" class="input"
                          placeholder="tarif de conduite" type="text" default="20 DT">
