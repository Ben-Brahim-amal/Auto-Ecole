...
<head>
  ...
  <!-- Tab CSS File -->
  <link rel="stylesheet" href="csstab1.css"><!-- Tab CSS File -->
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      <td class='select'>
        <a class='button'>
          <select name="maliste">
            ...
            <option value=" ajou">ajou</option>
            <option value=" ajou">
              <?php echo "<a href='admin_vue_candidats.php/?id_c=" . $row['id_c'] . "'>inscrire<a/>";
              ?>
            </option>
          </select>
        </a>
      ...
      <div class="fiche">
        ...
        <div class='signup-container'>
          <img src="<?php echo $row['img_path'] ?>" width="400px" height="500px">
        ...
        <!-- echo "<a href='admin_vue_candidats.php/?id_c=" . $row[' id_c'] . "'>inscrire<a/>" ; } if (isset($_GET['id_c']))
      { inscrire($_GET['id_c']); } ?> -->
      </div>
      </section>
  </main>
