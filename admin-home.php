...
<body>
  ...
  <main>
    <section id="about" class="about">
      ...
      <div class="container">
        <h1>Les Candidats</h1> <br>
        <!-- admin_vue_candidats.php   $row['id_c'] ?> -->
        <?php
        $stmt = $conn->prepare('SELECT nom,prenom,id_c,img_path FROM candidats where formation="en cours"');
        $stmt->execute();
        $result = $stmt->get_result();
        echo '<ol style="display: flex; flex-wrap: wrap; column-gap: 50px;  width:90%; align-content: flex-start;">';
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<a href='admin_modif_candidats.php?id_c=" . $row['id_c'] . "'>  Informations</a></td>";
          echo '<br></figure>';
        }
    ...
    <div class="container">
      <h5><a href="admin_ajout_candidat.php">ajouter un candidat-></a></h5>
    </div>
    <section id="about" class="about">
      <div><br>
        <br>
      ...
      <div class="container">
        <h1>Les Moniteurs</h1> <!-- admin_vue_candidats.php   $row['CIN'] ?> -->
        <?php
        $stmt = $conn->prepare('SELECT nom,prenom FROM Moniteurs');
        $stmt->execute();
        $result = $stmt->get_result();
        echo '<ol style="display: flex; flex-wrap: wrap; column-gap: 50px;  width:90%; align-content: flex-start;">';
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<a href='admin_modif_candidats.php'>  Informations</a></td>";
          echo '<br></figure>';
        }
